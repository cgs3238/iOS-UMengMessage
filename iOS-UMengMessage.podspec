...
Pod::Spec.new do |s|
  ...
  s.preserve_paths = "UMessage_Sdk_1.2.0/libUMessage_Sdk_1.2.0.a"
  ...
  s.xcconfig = { "LIBRARY_SEARCH_PATHS" => "$(PODS_ROOT)/iOS-UMengMessage/UMessage_Sdk_1.2.0/" }
