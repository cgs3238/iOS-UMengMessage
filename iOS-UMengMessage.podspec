...
Pod::Spec.new do |s|
  ...
  友盟消息推送SDK无IDFA版
  1.3.0 主要更新：
    改变1.2.7版本中初始化后直接往苹果注册devicetoken的逻辑。
    新增registerForRemoteNotifications方法统一管理往苹果注册devicetoken。
    去除1.2.7版本中加入的utdid.framework。
    支持IPv6。
  1.2.7 主要更新：
    SDK可自动捕获注册、错误等行为。
  1.2.6 主要更新：
  ...
  s.source       = { :git => "https://github.com/cgs3238/iOS-UMengMessage.git", :tag => s.version.to_s }
  ...
  s.source_files  = "UMessage_Sdk_1.3.0/*.{h,m}"
  # s.exclude_files = ""
  ...
  s.xcconfig = { "LIBRARY_SEARCH_PATHS" => "$(PODS_ROOT)/iOS-UMengMessage/UMessage_Sdk_1.3.0/" }
